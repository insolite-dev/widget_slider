...
Before you open a new issue, check to see if the problem has [already been reported](https://github.com/anonistas/widget_slider/issues). If it has and **the issue is still open**, add a comment to the existing issue instead of creating a new one.
...
If you've fixed a bug, started working on an enhancement, or done something else, you can [create a pull request](https://github.com/anonistas/widget_slider/pulls) to start a conversation about your changes.
...
5. [**Open a pull request**](https://github.com/anonistas/widget_slider/pulls) to merge your branch into `develop`.
